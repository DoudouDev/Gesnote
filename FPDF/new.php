<?php require('./fpdf.php'); // Création de la class PDF
class PDF extends FPDF
{
    // Header
    function Header()
    {
        // Logo : 8 >position à gauche du document (en mm), 2 >position en haut du document, 80 >largeur de l'image en mm). La
        // hauteur est calculée automatiquement.
        ...
        $this->SetX(70);
        // Texte : 60 >largeur ligne, 8 >hauteur ligne. Premier 0 >pas de bordure, 1 >retour à la ligneensuite, C >centrer
        // texte, 1> couleur de fond ok
...
$pdf->AliasNbPages(); // Sous-titre calées à gauche, texte gras (Bold), police de caractère 11
...
entete_table($position_entete); // affichage à l'écran...
$pdf->Output('', '', true);